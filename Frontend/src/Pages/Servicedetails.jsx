  ...
  const servicesData = [
...

    {
      ...
      category: "Pedicure Services",
       description:
        "Relaxing foot care treatments using organic and hygienic methods.",
      services: [
        {
        ...
        },
        {
          ...
          staff: ["Neha"],
          note:
            "Doctor fish remove dead skin naturally, improves blood circulation & gives deep relaxation.",
        },
      ],
      suggestedProducts: [
        {
      ...
      {category.services.map((service, index) => (
        <div key={index} className="card p-4 mb-4 shadow-sm">
          ...
          <button>
           ...
           Register then book your service</Link>
          </button>
        </div>
      ))}
    </div>
